...
- [**固件**]({{< relref "/firmware/" >}})
  - [如何更新固件]({{< relref "/firmware/firmware" >}})
  - [Grub编译与调试]({{< relref "/firmware/grub" >}})
  - [从UEFI如何启动到系统]({{< relref "/firmware/uefi" >}})
  - [PMON的使用方法]({{< relref "/firmware/pmon" >}})

- [**系统**]({{< relref "/system/" >}})
  - [生成系统下的一些文件]({{< relref "/system/gen_sys_file" >}})
  - [新世界Archlinux系统安装]({{< relref "/system/install_archlinux" >}})
...
- [**应用**]({{< relref "/applications/" >}})
  ...
  - [在龙芯3A5000上运行Windows程序]({{< relref "/applications/lat" >}})
  - [龙芯平台使用clash]({{< relref "/applications/clash" >}})
